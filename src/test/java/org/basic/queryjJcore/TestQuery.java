...
public class TestQuery
{
  ...
  public void testQuery11()
  {
    ...
    Query and1Query = new Query("r").andCompare("t.col1", "1", Integer.class).andCompare("t.col2", "My");
    Query and2Query = new Query("s").andCompare("t.col3", "3", Integer.class).andCompare("t.col4", "My4*");
